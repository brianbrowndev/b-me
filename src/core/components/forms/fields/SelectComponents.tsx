...
import { makeStyles, Theme, createStyles,  emphasize } from '@material-ui/core/styles';
...
export { Menu, SingleValue, MultiValue, ValueContainer, Placeholder, Option, Control, inputComponent, NoOptionsMessage, useSelectStyles} ;