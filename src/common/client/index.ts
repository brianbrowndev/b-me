...
export class BookClient extends ApiClientBase {
    ...
    getBookCategories(): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books/categories";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetBookCategories(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    getBooks(): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getBooks2(year: string | null, categoryNames?: string[] | null | undefined): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books/year/{year}?";
        if (year === undefined || year === null)
            throw new Error("The parameter 'year' must be defined.");
        url_ = url_.replace("{year}", encodeURIComponent("" + year)); 
        if (categoryNames !== undefined)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetBooks2(_response);
        });
    }

    protected processGetBooks2(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    getBooks3(name: string | null, year: string | null, categoryNames?: string[] | null | undefined): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books/year/{year}/user/{name}?";
        if (name === undefined || name === null)
            throw new Error("The parameter 'name' must be defined.");
        url_ = url_.replace("{name}", encodeURIComponent("" + name)); 
        if (year === undefined || year === null)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetBooks3(_response);
        });
    }

    protected processGetBooks3(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    getBooks4(name: string | null, year: string | null, category: string | null): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books/year/{year}/user/{name}/category/{category}";
        if (name === undefined || name === null)
            throw new Error("The parameter 'name' must be defined.");
        url_ = url_.replace("{name}", encodeURIComponent("" + name)); 
        if (year === undefined || year === null)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetBooks4(_response);
        });
    }

    protected processGetBooks4(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    getBooksByName(name: string | null, year: string | null, bookName: string | null): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books/year/{year}/user/{name}/book/{bookName}";
        if (name === undefined || name === null)
            throw new Error("The parameter 'name' must be defined.");
        url_ = url_.replace("{name}", encodeURIComponent("" + name)); 
        if (year === undefined || year === null)
        ...
        if (bookName === undefined || bookName === null)
            throw new Error("The parameter 'bookName' must be defined.");
        url_ = url_.replace("{bookName}", encodeURIComponent("" + bookName)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetBooksByName(_response);
        });
    }

    protected processGetBooksByName(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    booksByAuthor(name: string | null): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/personal/books/author/{name}";
        if (name === undefined || name === null)
            throw new Error("The parameter 'name' must be defined.");
        url_ = url_.replace("{name}", encodeURIComponent("" + name)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processBooksByAuthor(_response);
        });
    }

    protected processBooksByAuthor(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
