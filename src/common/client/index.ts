...
export class CoreClient extends ApiClientBase {
  ...
  getFiscalYears(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/core/fiscal-years";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getUsers(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/core/users";
    url_ = url_.replace(/[?&]$/, "");
...
export class EventClient extends ApiClientBase {
  ...
  getEvents(): Promise<Event[]> {
    let url_ = this.baseUrl + "/event/events";
    url_ = url_.replace(/[?&]$/, "");
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : <Event[]>JSON.parse(_responseText, this.jsonParseReviver);
        return result200;
      });
    } else if (status === 404) {
      return response.text().then((_responseText) => {
  ...
  getReoccuringTypes(): Promise<ReoccuringType[]> {
    let url_ = this.baseUrl + "/event/reoccuringTypes";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetReoccuringTypes(
    response: Response
  ): Promise<ReoccuringType[]> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  getEvent(id: number): Promise<Event> {
    let url_ = this.baseUrl + "/event/events/{id}";
...
export class ExpenseClient extends ApiClientBase {
  ...
  getExpenses(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/finance/expenses";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getExpenses2(
    year: string | null,
    monthNames?: string[] | null | undefined
  ): Promise<FileResponse> {
    let url_ = this.baseUrl + "/finance/expenses/year/{year}?";
    if (year === undefined || year === null)
      throw new Error("The parameter 'year' must be defined.");
    url_ = url_.replace("{year}", encodeURIComponent("" + year));
    if (monthNames !== undefined && monthNames !== null)
      monthNames &&
        monthNames.forEach((item) => {
          url_ += "monthNames=" + encodeURIComponent("" + item) + "&";
        });
    url_ = url_.replace(/[?&]$/, "");
  ...
  getExpenses3(
    ...
    let url_ = this.baseUrl + "/finance/expenses/year/{year}/user/{name}";
  ...
  getUserMonthlyExpenses(
    ...
    let url_ =
      this.baseUrl + "/finance/expenses/year/{year}/user/{name}/monthly?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetUserMonthlyExpenses(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getUserYearlyExpenses(
    ...
    let url_ =
      this.baseUrl +
      "/finance/expenses/year/{year}/user/{name}/category/{category}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetUserYearlyExpenses(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class FinanceDeprecatedClient extends ApiClientBase {
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  private baseUrl: string;
  ...
  getTransactionCategories(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/finance/transaction-categories";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getExpenseMonths(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/finance/expense-months";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getUserProfile(name: string | null): Promise<FileResponse> {
    let url_ = this.baseUrl + "/finance/user-profiles/{name}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    url_ = url_.replace(/[?&]$/, "");
  ...
  getUserSummary(name: string | null, year: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/finance/user-summaries/year/{year}/user/{name}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  getUserCategoriesGrowth(
    name: string | null,
    year: string | null
  ): Promise<FileResponse> {
    let url_ =
      this.baseUrl + "/finance/user-categories-growth/year/{year}/user/{name}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetUserCategoriesGrowth(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class TransactionDeprecatedClient extends ApiClientBase {
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  private baseUrl: string;
  ...
  getTransactions(
    ...
    let url_ = this.baseUrl + "/finance/transactions/year/{year}/user/{name}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
      throw new Error("The parameter 'year' must be defined.");
    url_ = url_.replace("{year}", encodeURIComponent("" + year));
    if (categoryNames !== undefined && categoryNames !== null)
      categoryNames &&
        categoryNames.forEach((item) => {
          url_ += "categoryNames=" + encodeURIComponent("" + item) + "&";
        });
    url_ = url_.replace(/[?&]$/, "");
  ...
  getTransactionsMonthly(
    ...
    let url_ =
      this.baseUrl +
      "/finance/transactions/year/{year}/user/{name}/monthly/range/{range}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetTransactionsMonthly(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getTransactions2(
    ...
    let url_ =
      this.baseUrl +
      "/finance/transactions/year/{year}/month/{month}/user/{name}/category/{category}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
...
export class FoodClient extends ApiClientBase {
  ...
  getFoodCategories(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/categories";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetFoodCategories(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getSupermarkets(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/supermarkets";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getCookbooks(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/cookbooks";
    url_ = url_.replace(/[?&]$/, "");
...
export class FoodProductClient extends ApiClientBase {
  ...
  getFoodProducts(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/products";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getFoodProducts2(name: string | null): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/products/product/{name}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    url_ = url_.replace(/[?&]$/, "");
  ...
  getAnnualFoodProducts(
    year: string | null,
    categoryNames?: string[] | null | undefined
  ): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/products/year/{year}?";
    if (year === undefined || year === null)
      throw new Error("The parameter 'year' must be defined.");
    url_ = url_.replace("{year}", encodeURIComponent("" + year));
    if (categoryNames !== undefined && categoryNames !== null)
  ...
  protected processGetAnnualFoodProducts(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getAnnualFoodProducts2(
    name: string | null,
    year: string | null,
    categoryNames?: string[] | null | undefined
  ): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/products/year/{year}/user/{name}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetAnnualFoodProducts2(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getAnnualFoodProducts3(
    ...
    let url_ =
      this.baseUrl +
      "/food/products/year/{year}/user/{name}/category/{category}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetAnnualFoodProducts3(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getAnnualFoodProductsByName(
    ...
    let url_ =
      this.baseUrl +
      "/food/products/year/{year}/user/{name}/food-product/{foodProductName}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
    ...
    url_ = url_.replace(
      "{foodProductName}",
      encodeURIComponent("" + foodProductName)
    );
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetAnnualFoodProductsByName(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class GroceryClient extends ApiClientBase {
  ...
  getLatestGrocery(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/groceries/grocery/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  getGroceries(
    ...
    let url_ = this.baseUrl + "/food/groceries/year/{year}/user/{name}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  getGroceriesByName(
    ...
    let url_ =
      this.baseUrl +
      "/food/groceries/year/{year}/user/{name}/grocery/{groceryName}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetGroceriesByName(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getGroceriesMonthly(
    ...
    let url_ =
      this.baseUrl + "/food/groceries/year/{year}/user/{name}/monthly?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  protected processGetGroceriesMonthly(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getTransactionsMonthly(
    ...
    let url_ =
      this.baseUrl +
      "/food/groceries/year/{year}/user/{name}/monthly/range/{range}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (year === undefined || year === null)
  ...
  getLatestGrocery2(
    ...
    let url_ =
      this.baseUrl +
      "/food/groceries/latest/{foodProduct}/supermarket/{supermarket}";
  ...
  protected processGetLatestGrocery2(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  checkoutGroceries(cart: GroceryCart): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/groceries";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processCheckoutGroceries(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class MealPlanClient extends ApiClientBase {
  ...
  getMealPlan(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/meal-plan/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  getMealPlans(name: string | null): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/user/{name}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    url_ = url_.replace(/[?&]$/, "");
  ...
  getMealPlanRecipes(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/recipes/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetMealPlanRecipes(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getMealPlanRecipe(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/recipe/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetMealPlanRecipe(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUpdateMealPlanRecipe(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processDeleteMealPlanRecipe(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getMealPlanGroceries(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/groceries/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetMealPlanGroceries(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  insertMealPlan(item: MealPlan): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/meal-plan";
    url_ = url_.replace(/[?&]$/, "");
  ...
  insertMealPlanRecipes(list: MealPlanRecipeList): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/recipes";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processInsertMealPlanRecipes(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  insertMealPlanRecipe(item: MealPlanRecipe): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/meal-plans/recipe";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processInsertMealPlanRecipe(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class RecipeClient extends ApiClientBase {
  ...
  getRecipeCategories(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/categories";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetRecipeCategories(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getRecipes(): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getRecipes2(
    ...
    let url_ = this.baseUrl + "/food/recipes/user/{name}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (categoryNames !== undefined && categoryNames !== null)
  ...
  getRecipesWithIngredient(
    ...
    let url_ = this.baseUrl + "/food/recipes/user/{name}/{ingredient}?";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
  ...
  protected processGetRecipesWithIngredient(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getRecipes3(
    ...
    let url_ = this.baseUrl + "/food/recipes/user/{name}/category/{category}";
    if (name === undefined || name === null)
      throw new Error("The parameter 'name' must be defined.");
    url_ = url_.replace("{name}", encodeURIComponent("" + name));
    if (category === undefined || category === null)
  ...
  getRecipe(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/recipe/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  getRecipeIngredient(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/ingredient/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetRecipeIngredient(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUpdateRecipeIngredient(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processDeleteRecipeIngredient(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  getRecipeIngredients(id: number): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/ingredients/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetRecipeIngredients(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  insertRecipe(item: Recipe): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/recipe";
    url_ = url_.replace(/[?&]$/, "");
  ...
  postIngredients(list: IngredientList): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/ingredients";
    url_ = url_.replace(/[?&]$/, "");
  ...
  insertRecipeIngredient(item: RecipeIngredient): Promise<FileResponse> {
    let url_ = this.baseUrl + "/food/recipes/ingredient";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processInsertRecipeIngredient(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class FinancePublicClient extends ApiClientBase {
  ...
  protected processGetTransactionsPerDay(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class FoodPublicClient extends ApiClientBase {
  ...
  protected processGetLatestMealPlan(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class CryptoClient extends ApiClientBase {
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  private baseUrl: string;
  ...
  getLookups(): Promise<CryptoHoldingLookupsDto> {
    let url_ = this.baseUrl + "/v1/cryptoholdings/lookups";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetLookups(
    response: Response
  ): Promise<CryptoHoldingLookupsDto> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  getCryptoPage(
    ...
    yearsSold?: number[] | null | undefined,
    holdingStatus?: string | null | undefined
  ): Promise<PaginationResponseOfCryptoInvestmentDto> {
    let url_ = this.baseUrl + "/v1/cryptoholdings/page?";
    ...
    if (coins !== undefined && coins !== null)
      coins &&
        coins.forEach((item) => {
          url_ += "coins=" + encodeURIComponent("" + item) + "&";
        });
    if (yearsSold !== undefined && yearsSold !== null)
      yearsSold &&
        yearsSold.forEach((item) => {
          url_ += "yearsSold=" + encodeURIComponent("" + item) + "&";
        });
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processGetCryptoPage(_response);
      });
  }

  protected processGetCryptoPage(
    response: Response
  ): Promise<PaginationResponseOfCryptoInvestmentDto> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : <PaginationResponseOfCryptoInvestmentDto>(
                JSON.parse(_responseText, this.jsonParseReviver)
              );
        return result200;
      });
  ...
  delete(id: number): Promise<void> {
    let url_ = this.baseUrl + "/v1/cryptoholdings/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
...
export interface CryptoHoldingLookupsDto {
  coins?: Lookup[];
  holdingStatus?: Lookup[];
}
...
export interface PaginationResponseOfCryptoInvestmentDto {
  items?: CryptoInvestmentDto[] | undefined;
  count?: number;
}

export interface CryptoInvestmentDto {
  id?: number | undefined;
  name?: string;
